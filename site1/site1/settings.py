...
SECRET_KEY = 'django-insecure-i7242ltv@b9z0oz5w5mz2v#jn&h=_!zjfnv_@nyclt9cf8z12b'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['192.168.0.20:8000','192.168.0.20']
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # Добавленный путь к директории шаблонов
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
